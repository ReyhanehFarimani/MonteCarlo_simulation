...
int main() {
    ...
    initializeParticles(particles, box, N, true, 92); // seed = 92

    // --- Thermodynamics and logger ---
    ThermodynamicCalculator calc(temperature, PotentialType::LennardJones, rcut);
    Logging logger("positions_T0.48_rho_0.3_N32_2.xyz", "data_T0.48_rho_0.3_N32_2.txt");
